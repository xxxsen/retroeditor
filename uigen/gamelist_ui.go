...
func (this *UIGamelistForm) SetupUI(Form *widgets.QWidget) {
	...
	this.LePlayer.SetReadOnly(true)
	...
	this.LeLastPlay.SetReadOnly(true)
	...
	this.LePlayCnt.SetReadOnly(true)
	...
	this.LeReleaseDate.SetReadOnly(true)
