...
func (this *UIGameditDialog) SetupUI(Dialog *widgets.QDialog) {
	...
	Dialog.SetGeometry(core.NewQRect4(0, 0, 933, 727))
	...
	this.VVideo = widgets.NewQWidget(Dialog, core.Qt__Widget)
	...
	this.Label15 = widgets.NewQLabel(Dialog, core.Qt__Widget)
	this.Label15.SetObjectName("Label15")
	this.GridLayout3.AddWidget3(this.Label15, 2, 0, 1, 1, 0)
	this.PicMarquee = widgets.NewQLabel(Dialog, core.Qt__Widget)
	...
	this.GridLayout4.AddLayout2(this.GridLayout3, 0, 1, 1, 1, 0)
	this.GridLayout2 = widgets.NewQGridLayout(Dialog)
	this.GridLayout2.SetObjectName("gridLayout_2")
	this.GridLayout2.SetContentsMargins(8, 0, 8, 8)
	...
	this.BtnSave = widgets.NewQPushButton(Dialog)
	this.BtnSave.SetObjectName("BtnSave")
	this.GridLayout2.AddWidget3(this.BtnSave, 0, 1, 1, 1, 0)
	this.GridLayout4.AddLayout2(this.GridLayout2, 1, 0, 1, 2, 0)
